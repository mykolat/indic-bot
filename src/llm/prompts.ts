  ...
  "decisions": [
    {
      ...
      "setup_type": "<trend_continuation|reversal|breakout|range_fade|momentum|none>",
      "directional_bias": "long" | "short" | "neutral",
      "entry_valid_now": true|false,
      "invalidators": ["<condition that kills this thesis>", "<another>"],
      "risk_flags": ["<thin_book|high_funding|low_volume|etc>"],
      "data_gaps": ["<missing_macro|stale_news|no_4h_data|etc>"],
      "abstain_reason": "<null or: no_setup|data_gap|conflicting_signals|low_volume|regime_unclear>",
      "session_context": {
